...
def extract_thread_features(thread, domain_ranks=None):
    main = thread['main']
    ...
    return {
        ...
        'from_domain_rank': domain_ranks.get(from_domain) if domain_ranks is not None else None,
...
GENERATED_HEADERS = set(map(lambda s: s.lower(), [
    'Feedback-Id',
    'X-Feedback-Id',
]))
